...
public class Enemy : MonoBehaviour
{
    ...
    public void startMovingOut() {
        ...
        try {
            ...
            // speed auf anderen rigidbody �bergbene 
            ...
            //kein moveout script vorhanden zerst�re enemy an dieser Stelle
            ...
            if (collision.gameObject == waypointObject[waypointIndex]) {
                if (moveToRandomWaypoints == true) {
                    ...
                    while (i == -1 || waypointObject.Count == i || i == waypointIndex) {
                        // grenzen um 1 Zahl erweiter da eck zaheln nur selten ausgew�rfelt werden
                        // wenn unm�gliche Zahl kommt wird zahl neu ermittelt
